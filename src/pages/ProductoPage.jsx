...
export default function ProductoPage() {
  ...
  const columns = [
    ...
    columnHelper.accessor("producto_almacen.proveedor.nombre", {
      header: "Proveedor",
      cell: (info) => info.renderValue(),
      footer: (info) => info.column.id,
      width: "10%",
    ...
    columnHelper.accessor("producto_almacen.existencias", {
      header: "Existencias",
      footer: (info) => info.column.id,
      width: "10%",
	  textAlign: "center",
    }),
    columnHelper.accessor("producto_almacen.descripcion", {
      header: "Descripción",
      footer: (info) => info.column.id,
      width: "10%",
    }),
